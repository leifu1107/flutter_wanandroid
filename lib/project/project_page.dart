...
import 'package:flutter_wanandroid/project/item_project.dart';
      ...
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return ItemProject(
              ...
              time: homeArticleListModel.data.datas[index].niceDate,imageUrl:
            homeArticleListModel.data.datas[index].envelopePic,
            );
          }),
    );
  }
