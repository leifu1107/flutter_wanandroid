...
@JsonSerializable()
class HomeArticleListModel extends Object {
  ...
  HomeArticleListModel(this.data,this.errorCode,this.errorMsg,);

  factory HomeArticleListModel.fromJson(Map<String, dynamic> srcJson) => _$HomeArticleListModelFromJson(srcJson);
